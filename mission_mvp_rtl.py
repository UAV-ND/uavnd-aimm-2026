...
# mission_mvp_rtl.py
#
# Same as mission_mvp through payload drop, then RTL instead of boat landing:
#   wait_for_auto_start
#   wait_for_handoff
#   guided_handoff
#   search_for_buoy
...
#   done
#
# Does not use: boat_radio, lidar, boat-class detector (lighter hardware).
...
log_path = '/home/uav-nano/Documents/aimm-dev/uavnd-aimm-2026/test/mission_mvp_rtl.log'
logging.basicConfig(
    level=logging.INFO,
...
def setup():
    log.info("=== mission_mvp_rtl.py started ===")
...
def main():
    ...
    try:
        ...
        log.info("=== mission_mvp_rtl.py finished ===")
